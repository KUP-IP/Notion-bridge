...
// NotionGate · Security
// PKT-341: Crash resilience — persistent log to ~/Library/Logs/NotionGate/
...
public actor LogManager {
    ...
    private init() {
        ...
        self.logDirectory = home.appendingPathComponent("Library/Logs/NotionGate")
        self.logFileURL = logDirectory.appendingPathComponent("notion-gate.log")
        let enc = JSONEncoder()
    ...
    private func rotateIfNeeded() {
        ...
        let rotatedURL = logDirectory.appendingPathComponent("notion-gate.log.1")
