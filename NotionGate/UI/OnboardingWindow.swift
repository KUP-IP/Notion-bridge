...
public final class OnboardingWindowController {
    ...
    public func show() {
        ...
        window.title = "Welcome to Notion Gate"
...
struct OnboardingView: View {
    ...
    private var welcomeStep: some View {
        VStack(spacing: 16) {
            ...
            Text("Welcome to Notion Gate")
                .font(.title)
                .fontWeight(.semibold)

            // D1: Removed "all" — was "— all with your permission."
            Text("Notion Gate connects your Notion agents to your Mac through a secure, local MCP server. Your agents can manage files, run command-line interface commands, steer your Mac, control your browser, and automate workflows — with your permission.")
                .font(.body)
    ...
    private var permissionsStep: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            Text("Notion Gate needs these permissions to work. Grant them one at a time in System Settings.")
                .font(.callout)
                .foregroundStyle(.secondary)
                .multilineTextAlignment(.center)
    ...
    private func openSystemSettings(for grant: PermissionManager.Grant) {
        ...
        case .automation:
            ...
            return
        case .contacts:
            // D2: Request contacts access first to trigger the macOS "NotionGate
    ...
    private var testConnectionStep: some View {
        VStack(spacing: 20) {
            ...
            Text("Make sure Notion Gate is running and your client can reach it.")
                .font(.callout)
                .foregroundStyle(.secondary)
                .multilineTextAlignment(.center)
                .padding(.horizontal, 16)
            ...
            Group {
                ...
                case .checking:
                    Text("Checking health endpoint...")
                        ...
                        .foregroundStyle(.secondary)
                case .success:
                    Text("Notion Gate is running and responding! You\u{2019}re all set.")
                        .font(.caption)
                        .foregroundStyle(.green)
