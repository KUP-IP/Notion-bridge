...
public enum ChromeModule {
    ...
    public static func register(on router: ToolRouter) async {
        ...
        await router.register(ToolRegistration(
            ...
            module: moduleName,
            tier: .open,
            description: "Capture the visible content of a Chrome tab as a PNG screenshot. Uses macOS screencapture to capture the Chrome window region. Returns the file path and dimensions.",
            inputSchema: .object([
                "type": .string("object"),
                "properties": .object([
                    "windowId": .object([
