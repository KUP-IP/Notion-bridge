...
# 2940 (0 failed); this branch measures 2962 (0 failed), confirmed 3x deterministic.
# Floor raised 2940 → 2962 (2940 +22) per the order-inversion rule.
FLOOR="${BRIDGE_TEST_FLOOR:-2962}"
