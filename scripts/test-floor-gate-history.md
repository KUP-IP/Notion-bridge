...
- 2026-09-06 · calendar free/busy v0 (Isaiah GO) · `3989 → 4007` (+18): read-only `calendar_free_busy` on EventKit FOCUS default; half-open `[start, end)` overlap (touching edges exclusive). +17 CalendarModuleTests + 1 access-denied nested. CI must re-measure.
