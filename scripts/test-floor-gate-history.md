...
- 2026-08-21 · bounded THREAD Messages M1 recovery · `3776 → 3780` (+4): explicit service is validated before side effects, recovered local evidence must match that service, duplicate Intent retries fail closed, and an exact existing Result can complete operator-review recovery without resending or duplicating the journal. Additive combined floor 3780 on codex/thread-m1-reactivation-v2.
